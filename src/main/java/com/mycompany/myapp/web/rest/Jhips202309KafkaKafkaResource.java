...
@RestController
@RequestMapping("/api/jhips-202309-kafka-kafka")
public class Jhips202309KafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(Jhips202309KafkaKafkaResource.class);
    ...
    public Jhips202309KafkaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
